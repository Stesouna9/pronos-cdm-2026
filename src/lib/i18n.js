...
const JA = {
  ...
  "StarKane remporte les mini-jeux !": "StarKaneがミニゲーム優勝！",
  "La compétition des mini-jeux est terminée : StarKane finit 1er et empoche +10 points au classement général. Les jeux restent dispo juste pour le fun et pour battre les records 🎮": "ミニゲーム大会終了：StarKaneが1位で総合ランキングに+10点。ゲームはお楽しみ＆記録更新用に引き続き遊べます🎮",
  "OK, bien joué StarKane !": "OK、StarKaneおめでとう！",
  "En mémoire de Bernard": "ベルナールを偲んで",
  "Le papa de Gabriel nous a quittés. Nos matchs, nos pronos, nos chambrages… on les partage un peu pour lui aussi. Une pensée pour Bernard, et pour toute sa famille. ❤️": "ガブリエルのお父さんが旅立ちました。試合も、予想も、じゃれ合いも、少し彼のために。ベルナールとご家族へ想いを込めて。❤️",
  "Une pensée pour lui 🕯️": "彼に想いを 🕯️",
  "Cette ligue est dédiée à la mémoire de Bernard, le papa de Gabriel.": "このリーグはガブリエルの父ベルナールに捧げます。",
  "Équipes": "チーム", "Équipes enregistrées": "チームを保存しました", "à déterminer": "未定",
  "Choisis les deux équipes de chaque match de phase finale, puis Enregistrer. ⚠️ Changer les équipes remet le score à zéro.": "決勝トーナメント各試合の2チームを選んで保存。⚠️ チーム変更でスコアはリセットされます。",
  "Aucun match de phase finale.": "決勝トーナメントの試合はありません。",
  "3e place": "3位決定戦", "16es": "ラウンド32", "8es": "ラウンド16", "Quarts": "準々決勝", "Demies": "準決勝",
  "Records": "記録", "Records de la ligue": "リーグ記録", "aucun record": "記録なし",
  "Joue pour le fun · bats les records": "楽しんで · 記録を破ろう",
  "Pas encore de record — bats-le !": "まだ記録なし — 作ろう！",
  "ton score": "あなたのスコア", "Rejouer": "もう一回",
  "Partie d'entraînement — non enregistrée.": "練習プレイ — 記録されません。",
  "🏅 Nouveau record de la ligue !": "🏅 リーグ新記録！",
  "Bien joué ! Rejoue pour battre le record.": "ナイス！もう一回挑戦して記録を破ろう。",
  "Les mini-jeux sont là juste pour le fun : pas de points au classement, mais essaie de battre le record de la ligue !": "ミニゲームはお楽しみ用：ランキングには反映されませんが、リーグ記録に挑戦しよう！",
  "Entraînement — score non enregistré.": "練習 — スコアは記録されません。",
  "Onglet Jeux : 5 mini-jeux juste pour le fun (pas de points au classement). Essaie de battre le record de la ligue ! La compétition des +10 points est terminée — bravo StarKane 🏆": "ゲームタブ：5つのミニゲーム（ランキング非対象）。リーグ記録に挑戦！+10点の大会は終了 — StarKaneおめでとう🏆",
