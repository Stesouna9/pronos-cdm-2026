...
const JA = {
  ...
  "vise une zone LIBRE (pas le rouge) et appuie au bon moment !": "空いた所（赤以外）を狙って、いいタイミングで押せ！",
  "TIRER": "シュート！", "À CÔTÉ !": "枠外！",
  "Banc large !": "バー拡大！", "Banc rétréci !": "バー縮小！", "Balle lente": "ボール減速",
  "Balle rapide !": "ボール加速！", "Vie +1 !": "ライフ+1！",
  ...
  "hors classement": "ランキング対象外", "Hors classement": "ランキング対象外",
  "Super Claude IA passe hors classement": "Super Claude IA はランキング対象外に",
  ...
  "Les 16es de finale sont là !": "ラウンド32が始まった！",
  "La phase à élimination directe commence : tu peux maintenant pronostiquer les 16 matchs des 16es de finale !": "ノックアウトステージ開始：ラウンド32の16試合を予想できます！",
  "Nouveau : les tirs au but": "新ルール：PK戦",
  "En phase finale, si tu pronostiques un match nul, choisis aussi QUI gagne aux tirs au but : +2 points bonus si tu vois juste ! (le score se juge à la fin du temps réglementaire, comme d'habitude)": "決勝トーナメントで引き分け予想のときは、PK戦の勝者も選ぼう：的中で+2ボーナス！（スコアはこれまで通り90分終了時で判定）",
  "Go, je pronostique !": "予想する！",
