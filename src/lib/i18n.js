...
const JA = {
  ...
  "Quiz coquin": "アダルトクイズ", "Décode les emojis": "絵文字解読", "Pendu coquin": "アダルトハングマン",
  "Plus haut / plus bas": "上か下か", "Géo coquine": "アダルト地理",
  "4 buts sur 5": "5本中4ゴール", "20 jongles": "リフティング20回", "série de 10": "10連続",
  "40 maillots": "ユニフォーム40枚", "8 sur 10": "10問中8問", "4 sur 5": "5問中4問",
  "6 sur 8": "8問中6問", "trouve le mot": "単語を当てる", "série de 5": "5連続", "5 sur 6": "6問中5問",
  ...
  "Coin coquin": "アダルトコーナー",
  "Humour et sous-entendus entre adultes — rien d'explicite, mais réservé aux majeurs.": "大人向けユーモア（露骨な内容なし）。18歳以上限定。",
  "Entrer dans le coin coquin": "アダルトコーナーに入る",
  "🔞 Coin coquin — humour et sous-entendus entre adultes. Tu confirmes que tu es majeur(e) ?": "🔞 アダルトコーナー — 大人向けユーモア。18歳以上ですか？",
  "Tir": "シュート", "but(s)": "ゴール",
  ...
  "vie(s)": "ライフ", "% de Français qui…": "フランス人の％…",
  "PLUS HAUT": "上", "PLUS BAS": "下",
};
